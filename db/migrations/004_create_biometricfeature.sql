...
-- identity_file (KNOWN, from enrollment) or a case_trace (QUESTIONED, from crime-scene
-- evidence) -- enforced by the exactly-one-source CHECK below. provenance is derivable
